        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              {...props}
            >
              <PanelLeft style={{ width: "1.25rem", height: "1.25rem" }} className="font-extrabold" />
